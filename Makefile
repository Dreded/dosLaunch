...
CC        = $(DJGPP_CC)
VENDOR    = vendor
CFLAGS    = -DHAVE_STDBOOL_H=1 -fgnu89-inline -Ivendor/allegro-4.2.2-xc/include -Ivendor/allegTTF/include
LDFLAGS   = -Lvendor/allegro-4.2.2-xc/lib/djgpp -lalleg -Lvendor/allegTTF/lib -lalttf
